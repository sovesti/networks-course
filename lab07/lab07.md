...
Клиент и сервер запускаются так же, как в предыдущих пунктах, но теперь клиенту можно прописать номер порта, на котором будет работать клиент:
...
А серверу - время в секундах, через которое считать клиента выключенным (стандартное значение - 10):
...
На скриншоте запущен сервер и два клиента на портах ```3040``` и ```3041```:

<img width="2794" height="431" alt="image" src="https://github.com/user-attachments/assets/b3f61fd4-408d-4a8a-8874-edfdf6b5456d" />

Через 10 секунд после выключения одного из клиентов:

<img width="2793" height="437" alt="image" src="https://github.com/user-attachments/assets/873d2058-528b-4d00-a6e8-cd4c8c0a7e2d" />
